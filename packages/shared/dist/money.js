 ...
 */
export function stakeCents(priceCents, contracts) {
 ...
 */
export function realizedPnlCents(priceCents, contracts, won) {
 ...
 * of the side held.
 */
export function unrealizedPnlCents(entryPriceCents, currentSidePriceCents, contracts) {
 ...
 */
export function feeOnNetPnlCents(netPnlCents, feeRate) {
    if (!(feeRate >= 0))
 ...
 */
export function periodTotals(pnls, feeRate) {
    let grossWins = 0;
    let grossLosses = 0;
 ...
 */
export function allocateSettlementCents(totalCents, contractsPerTrade) {
    if (contractsPerTrade.length === 0)
        return [];
...
export function formatUsd(cents, opts = {}) {
