 ...
 * pay the same.
 */
export function kalshiFeeCents(priceCents: number, contracts = 1): number {
...
export function netIfHitCents(priceCents: number): number {
...
export function netIfMissCents(priceCents: number): number {
 ...
 */
export function breakevenHitRate(priceCents: number): number {
...
export function expectedNetCents(priceCents: number, hitRate: number): number {
